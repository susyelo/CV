...
\title{NSF Postdoctoral Associate\vspace{0.1cm} \newline Macroecology and Macroevolution\vspace{-0.2cm}}	% optional, remove the line if not wanted
\address{Kenyon College}{Gambier OH, USA\vspace{0.1cm}}{}    	% optional, remove the line if not wanted
\mobile{+1 (740) 504 6838}                    							% optional, remove the line if not wanted
\email{susyelo@gmail.com}									% optional, remove the line if not wanted
\social[github]{https://github.com/susyelo}                      			% optional, remove the line if not wanted
...
\cventry{2018--present}{Visiting scholar}{University of Pittsburgh, Biological Sciences}{}{USA}{}
...
\cventry{2017--present}{NSF Postdoctoral Associate}{Kenyon College, Biology}{}{Gambier, USA}{}
