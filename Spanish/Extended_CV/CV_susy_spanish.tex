...
%		\end{itemize}}
\cventry{2017}{Instructora y docente auxiliar}{Natural History Museum \& Imperial College London}{}{Reino Unido}{}
\cvline{}{Instructora y docente del curso ``M\'etodos en macroecolog\'ia y macroevoluci\'on'' para la maestria MSc ``Taxonomy and Biodiversity'', incluyendo t\'opicos como ``Enfoques filogen\'eticos para el estudio de diversificaci\'on'' y ``F\'osiles en filogen\'etica''.}

\cventry{2013--2016}{Instructora}{Imperial College London}{}{Reino Unido}{}
\cvline{}{Instructora de cursos de pregrado como ``Bioestad\'istica computacional'', ``Ecolog\'ia y evoluci\'on'', ``Biodiversidad y biolog\'a de la conservaci\'on'', ``Introducci\'on a R'', ``Fundamentos en estad\'istica en R''}
%
