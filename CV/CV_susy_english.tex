...
I am an early career researcher focusing on the study of large-scale patterns of biodiversity and the ecological and evolutionary processes that shaped them. I am also interested in understanding how human pressures have affected and will affect the biodiversity in tropical regions. Throughout my career I have gained extensive experience in the field of data science including data processing and visualization, advanced statistical and spatial analysis.  
...
%		\myitem Researching the consequences of climatic stability and biome age and area effects on seed plant diversity. 
		
%		\myitem Carrying out paleoclimate reconstructions using machine learning methods such as random forest to calibrate biogeographic biomes inferences.
		
%		\myitem Co-teaching of the BSc course ``Global Ecology and Biogeography'' at Kenyon College. 
		
%		\myitem Taught and organized lectures and assignments for Ecoinformatics skills section of the ``Global Ecology and Biogeography'' course which include: Introduction to data science R, data managing and processing, data visualization, spatial analysis and reproducibility \url{https://globalecologybiogeography.github.io/Ecoinformatics/} 
...
\cventry{2008--2010}{Teaching Assistant}{Systematics BSc course, Universidad Industrial de Santander; Bioinformatics MSc course, Universidad Industrial de Santander}{Bucaramanga}{Colombia}{}
...
\cvline{}{%
	\begin{itemize}\setlength\itemindent{15pt}
		\myitem Researched the dynamics of diversification of the megadiverse plant genus Solanum using a collation of geographical, genetic and taxonomic data along with phylogenetic comparative methods. 
		\myitem Studied large-scale patterns of plant diversity and their responses to land-use change from data of a global collation of local field-based studies. 
		\myitem Carried out large-scale evolutionary modelling exercise on a high-performance Linux cluster.
\end{itemize}}
